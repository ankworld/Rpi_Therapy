...
"}")
        ...
        self.lbl_in1 = QtWidgets.QLabel(self.page_auto_add)
        self.lbl_in1.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_in1.setObjectName("lbl_in1")
        self.gridLayout_2.addWidget(self.lbl_in1, 0, 1, 1, 1)
        self.lbl_in3 = QtWidgets.QLabel(self.page_auto_add)
        self.lbl_in3.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_in3.setObjectName("lbl_in3")
        self.gridLayout_2.addWidget(self.lbl_in3, 2, 1, 1, 1)
        self.lbl_in2 = QtWidgets.QLabel(self.page_auto_add)
        self.lbl_in2.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_in2.setObjectName("lbl_in2")
        self.gridLayout_2.addWidget(self.lbl_in2, 1, 1, 1, 1)
        self.btn_min_1 = QtWidgets.QPushButton(self.page_auto_add)
        self.btn_min_1.setObjectName("btn_min_1")
        self.gridLayout_2.addWidget(self.btn_min_1, 0, 2, 1, 1)
        ...
        self.btn_plus_1 = QtWidgets.QPushButton(self.page_auto_add)
        self.btn_plus_1.setObjectName("btn_plus_1")
        self.gridLayout_2.addWidget(self.btn_plus_1, 0, 3, 1, 1)
        self.btn_min_2 = QtWidgets.QPushButton(self.page_auto_add)
        self.btn_min_2.setObjectName("btn_min_2")
        self.gridLayout_2.addWidget(self.btn_min_2, 1, 2, 1, 1)
        self.btn_plus_2 = QtWidgets.QPushButton(self.page_auto_add)
        self.btn_plus_2.setObjectName("btn_plus_2")
        self.gridLayout_2.addWidget(self.btn_plus_2, 1, 3, 1, 1)
        self.btn_min_3 = QtWidgets.QPushButton(self.page_auto_add)
        self.btn_min_3.setObjectName("btn_min_3")
        self.gridLayout_2.addWidget(self.btn_min_3, 2, 2, 1, 1)
        self.btn_plus_3 = QtWidgets.QPushButton(self.page_auto_add)
        self.btn_plus_3.setObjectName("btn_plus_3")
        self.gridLayout_2.addWidget(self.btn_plus_3, 2, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_add_con, 3, 2, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.btn_cancel, 3, 0, 1, 2)
        ...
        MainWindow.setTabOrder(self.btn_auto_back, self.btn_cancel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_in1.setText(_translate("MainWindow", "0"))
        self.lbl_in3.setText(_translate("MainWindow", "0"))
        self.lbl_in2.setText(_translate("MainWindow", "0"))
        self.btn_min_1.setText(_translate("MainWindow", "-"))
        self.lbl_s2.setText(_translate("MainWindow", "Ankle (times)"))
        self.lbl_spd.setText(_translate("MainWindow", "Speed (%)"))
        self.lbl_s1.setText(_translate("MainWindow", "Knee (times)"))
        self.btn_plus_1.setText(_translate("MainWindow", "+"))
        self.btn_min_2.setText(_translate("MainWindow", "-"))
        self.btn_plus_2.setText(_translate("MainWindow", "+"))
        self.btn_min_3.setText(_translate("MainWindow", "-"))
        self.btn_plus_3.setText(_translate("MainWindow", "+"))
