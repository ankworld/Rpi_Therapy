...
class Ui_ControlPanelMW(object):
    def setupUi(self, ControlPanelMW):
        ...
        self.gridLayout_2.addWidget(self.freqPinM1, 1, 1, 1, 1)
        ...
        self.pwmPinM1 = QtWidgets.QLineEdit(self.groupBox)
        self.pwmPinM1.setObjectName("pwmPinM1")
        self.gridLayout_2.addWidget(self.pwmPinM1, 1, 0, 1, 1)
        ...
        self.pwmPinM2 = QtWidgets.QLineEdit(self.groupBox_2)
        self.pwmPinM2.setObjectName("pwmPinM2")
        self.gridLayout_9.addWidget(self.pwmPinM2, 1, 0, 1, 1)
        self.freqPinM2 = QtWidgets.QLineEdit(self.groupBox_2)
        self.freqPinM2.setObjectName("freqPinM2")
        self.gridLayout_9.addWidget(self.freqPinM2, 1, 1, 1, 1)
        ...
        ControlPanelMW.setTabOrder(self.lowPinM1, self.pwmPinM1)
        ControlPanelMW.setTabOrder(self.pwmPinM1, self.freqPinM1)
        ControlPanelMW.setTabOrder(self.freqPinM1, self.saveMotor1)
        ControlPanelMW.setTabOrder(self.saveMotor1, self.highPinM2)
        ControlPanelMW.setTabOrder(self.highPinM2, self.lowPinM2)
        ControlPanelMW.setTabOrder(self.lowPinM2, self.pwmPinM2)
        ControlPanelMW.setTabOrder(self.pwmPinM2, self.freqPinM2)
        ControlPanelMW.setTabOrder(self.freqPinM2, self.saveMotor2)
    ...
    def retranslateUi(self, ControlPanelMW):
        ...
        self.pwmPinM1.setPlaceholderText(_translate("ControlPanelMW", "PWM Pin"))
        ...
        self.pwmPinM2.setPlaceholderText(_translate("ControlPanelMW", "PWM Pin"))
